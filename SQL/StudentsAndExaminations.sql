...
-- Create Examinations table if it does not exist
...
select s.student_id, s.student_name, sj.subject_name, count(ex.subject_name) as [attended_exams]
from Students as s 
cross join Subjects as sj
left join Examinations as ex 
on s.student_id = ex.student_id and sj.subject_name = ex.subject_name
